...
def main(date):
    ...
    input_path = f"gs://airflow-projetcs-gds/airflow-project-2/data/orders_{date}.csv"
    ...
    output_path = f"gs://airflow-projetcs-gds/airflow-project-2/output/processed_orders_{date}"
