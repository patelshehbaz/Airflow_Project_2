...
def main(date):
    ...
    input_path = f"gs://airflow-projets-gds/AIRFLOW_PROJECT_2/data/orders_{date}.csv"
    ...
    output_path = f"gs://airflow-projets-gds/AIRFLOW_PROJECT_2/output/processed_orders_{date}"
